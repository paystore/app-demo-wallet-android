...
public class ValidateCardHolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_validate_card_holder);
        ...
        this.edtCellPhoneNumber.setText("83987654321");
        this.edtNationalDocument.setText("80037203037");
    }

    public void submitValidateCardHolder(View view) {
        ...
        Log.d("FORM ValidateCardHolder", this.cellPhoneNumber + " " + this.nationalDocument);

        validateCardHolderTest();
    }

    public void validateCardHolderTest() {
            ...
            apiService.revalidateCardHolder(this.nationalDocument, revalidateCardholderRequestDTO, new IWalletCallback<SaveCardholderResponse>() {
                ...
                public void onFailure(Throwable throwable) {
                    ...
                    handler.post(() -> DialogUtils.showMessage(getString(R.string.title_error),
                            ...
                            ValidateCardHolderActivity.this,
